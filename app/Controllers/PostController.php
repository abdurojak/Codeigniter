...
class PostController extends BaseController {
    ...
    public function add() {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            $file->move(ROOTPATH.'public/uploads/avatar', $fileName);
            ...
            foreach ($posts as $post) {
                ...
                <div class="card shadow-sm">
                  ...
                  <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <a href="#" id="' . $post['id'] . '" data-bs-toggle="modal" data-bs-target="#edit_post_modal" class="btn lime btn-sm post_edit_btn">Edit</a>

                      <a href="#" id="' . $post['id'] . '" class="btn pink btn-sm post_delete_btn">Delete</a>
                    </div>
                  </div>
                </div>
              </div>';
